...
| 3 | - Thiết lập kịch bản kiểm thử tải chi tiết, gửi lượng lớn HTTP requests đồng thời qua Application Load Balancer để đẩy CPU của máy chủ lên cao. | 30/06/2026 | 01/07/2026 |  |
| 4 | - Thực thi kịch bản kiểm thử, theo dõi giám sát chỉ số trên CloudWatch để kiểm tra quá trình ASG tự động tạo thêm máy chủ (Scale-out). | 01/07/2026 | 02/07/2026 |  |
| 5 | - Theo dõi tiến trình tự động giảm số lượng máy chủ (Scale-in) khi tải giảm, thực hiện điều chỉnh cấu hình Cooldown Period tối ưu nhất. | 02/07/2026 | 03/07/2026 |  |
