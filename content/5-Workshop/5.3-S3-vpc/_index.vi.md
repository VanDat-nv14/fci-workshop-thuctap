...
# Khởi tạo VPC, NAT Gateway và Security Groups
...
![Cấu hình VPC and more – Name, CIDR, số lượng Subnets và Preview](/images/aws-picture/vpc-1.png)
...
![Cấu hình NAT Gateway None, VPC Endpoint S3 Gateway và DNS options](/images/aws-picture/vpc-2.png)
...
![Cấu hình NAT Gateway – Name, Availability mode, VPC](/images/aws-picture/vpc-nat-1.png)
...
![Xác nhận Tags và nhấn Create NAT gateway](/images/aws-picture/vpc-nat-2.png)
...
> [!NOTE]
> NAT Gateway tính phí theo **giờ** và **lượng dữ liệu**. Nhớ xóa sau khi hoàn thành lab tại bước [5.6 – Dọn dẹp](../5.6-Cleanup/).
...
![Tạo rookwork-alb-sg với Inbound HTTP/HTTPS từ mọi nơi](/images/aws-picture/sg-alb-1.png)
...
![Tạo backend-sg – Inbound để trống, Outbound mặc định](/images/aws-picture/sg-be-1.png)
...
![Inbound rules của backend-sg: Port 8080 và 80 chỉ nhận từ rookwork-alb-sg](/images/aws-picture/sg-be-2.png)
...
![Edit inbound rules của rds-ec2-1: PostgreSQL port 5432 chỉ từ ec2-rds-1 và backend-sg](/images/aws-picture/sg-rds-1.png)
